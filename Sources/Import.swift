/*╔══════════════════════════════════════════════════════════════════════════════════════════════════╗
  ║ Import.swift                                                                             Scenery ║
  ║ Created by Gavin Eadie on Feb18/24..    Copyright © 2024 Ramsay Consulting. All rights reserved. ║
  ╚══════════════════════════════════════════════════════════════════════════════════════════════════╝*/
...
let elementsStore = ElementsStore(baseName: "com.ramsaycons.Scenery")

/*┏━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━┓
  ┃ loadGroup(..) will load an elementsGroup from the elementStore (if it can) or from the network.  ┃
  ┃ If from the network, this function will return nil until a group is obtained, then it will also  ┃
  ┃ populate the elementStore so the next call will pull from the elementStore ..                    ┃
  ┃                                                                     .. uses Celestrak JSON data  ┃
  ┃                                      .. call repeatedly till elementsGroup is non-nil then stop  ┃
  ┗━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━┛*/
...
/*┏━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━┓
  ┃ fetchFrom(..) performs the network operation to acquire the requested data as a String ..        ┃
  ┃                                                     .. fails if:                                 ┃
  ┃                                                          the URL is for a file                   ┃
  ┃                                                          the server returns other than a "200"   ┃
  ┃                                                          the data returned is not UTF8           ┃
  ┃                                                          any other Badness™                      ┃
  ┗━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━┛*/
